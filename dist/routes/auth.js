...
router.post("/signup", async (req, res) => {
    const data = req.body;
    try {
        const success = await (0, authService_1.signUpUser)(data);
        const resData = {
            status: 200,
            success: true,
            message: "Success",
...
router.post("/signin", async (req, res) => {
    ...
    try {
        ...
        const tokens = await (0, authService_1.signInUser)(email, password);
...
router.get("/me", authMiddleware_1.authenticateMe, (req, res) => {
    const user = req.user;
    return res.json({
        success: true,
        user: {
...
router.post("/confirm", async (req, res) => {
    ...
    try {
        await (0, authService_1.confirmSignUp)(email, code);
...
router.post("/resend", async (req, res) => {
    ...
    try {
        await (0, authService_1.resendConfirmationCode)(email);
        return res.status(200).json({
            status: 200,
            success: true,
